...
export default function Product({
    ...
    return (
        <div className="bg-gray-200 shadow-md flex flex-col justify-between transition duration-500 ease-in-out hover:scale-180 hover:shadow-xl ">
            ...
            <div className="mx-4 text-md md:text-base lg:text-lg font-semibold">{name}</div>
            <div className="mx-4 text-xs md:text-sm lg-text-base ">{description.substring(0, 100)}....</div>
